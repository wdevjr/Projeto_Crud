...
<script>
function envia() {
	opener.document.f1.idCidade.value = document.f2.CodCidade.value;
...
<f:view>
	...
	<h:form>
		...
		<h:messages/>
		 ...
		 <fieldset>
			...
			<h:panelGrid columns="3" style=" width : 722px;">
				...
				<h:commandButton value="Pesquisar" action="#{CidadeManagedBean.pesquisaCidades}" style="width: 85px; height: 30px; "/>
			...
			<h:dataTable value="#{CidadeManagedBean.lista}" var="item" styleClass="tablecloth-theme" headerClass="header" rowClasses="row1,row2" width="55%"  style=" width : 736px;">	
				...
				<h:column>
					<f:facet name="header">
						...
						<h:commandLink value="Selecionar" type="submit" action="apendCidade" actionListener="#{CidadeManagedBean.findCidade}" >
        ...
        <fieldset> <legend>Dados de Cidades</legend>
			...
			<br>
			<INPUT TYPE=button VALUE="enviar Formulário ..." onclick="envia()" style="width: 130px; height: 31px; ">
						<div align="right">
			<input type="button" value="Fechar" onclick="javascript:window.close()" style="width: 69px; height: 33px; ">
			</div>
			</fieldset>
