		...
		<f:view>
         ...
         <h:form>
			...
			<br>
				...
				<h:dataTable value="#{PessoaManagedBean.lista}" rendered="#{PessoaManagedBean.listSimouNao}" var="item" styleClass="tablecloth-theme" headerClass="header" rowClasses="row1,row2" style="height: 82px; ">
					<h:column>
						<f:facet name="header" >
