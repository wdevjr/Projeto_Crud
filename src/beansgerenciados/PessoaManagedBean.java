...
public class PessoaManagedBean implements Serializable{
	...
	public List<Pessoa> getListaPessoasComParametro(String nomePessoa) {
		return lista = this.pessoaFacade.FindAllComNovoProcPesquisa(nomePessoa);
	}



	public String pesquisaPessoas() {
		lista = getListaPessoasComParametro(descPessoa);
